...
legend("bottomright",
       legend=c(
         expression(theta==1.5~","~q==0.75),
         expression(theta==1.5~","~q==0.50),
         expression(theta==1.5~","~q==0.25),
         expression(theta==1.5~","~q==0.10)
       ),
       col=cols,
       lty=ltys,
       lwd=2,
...
rm(list = ls())
theta <- 0.5
q.values <- c(0.75, 0.60, 0.50, 0.40)
Cq <- function(theta, q){
  ((2-q)*(3-2*q)*(4-3*q)*theta^3) /
    (theta^3*(3-2*q)*(4-3*q)+2)
}
...
legend("topright",
       legend=c(
         expression(theta==0.5~","~q==0.75),
         expression(theta==0.5~","~q==0.60),
         expression(theta==0.5~","~q==0.50),
         expression(theta==0.5~","~q==0.40)
       ),
       col=cols,
       lty=ltys,
       lwd=2,
...
legend("topright",
       legend=c(
         expression(theta==0.80~","~q==1.05),
         expression(theta==0.80~","~q==1.20),
         expression(theta==0.80~","~q==1.30),
         expression(theta==0.80~","~q==1.32)
       ),
       col=cols,
       lty=ltys,
       lwd=2,
